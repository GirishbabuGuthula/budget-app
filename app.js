alert('After entering the fields...Press "ENTER" to enter the income and expenses');
// BUDGET CONTROLLER
var budgetController = (function () {
    ...
    return {
        ...
        caluclateBudget : function (){
            ...
            // caluclate the percentage of income and expenses
...
var controller = (function (budgetCtrl,uiCtrl){
    ...
    var ctrlAddItem = function (){
        ...
        if(input.description !== "" && !isNaN(input.value) && input.value > 0){
            ...
            // 5.caluclate and update the budget
            updateBudget();
    ...
    var ctrlDeleteItem = function (event){
        ...
        if(itemID){
            ...
            // 4.caluclate and update the percentages
            updatePercentages();
